...
export default function HoChiMinhKitchenPage() {
  return (
    <>
      <PageHero eyebrow="Khu vực phía Nam" title="Thi công bếp F&B TPHCM" description="New Sky hỗ trợ dự án F&B khu vực phía Nam thông qua văn phòng miền Nam và năng lực tự sản xuất từ xưởng Thượng Hồng, Hưng Yên." />
